...
module.exports = {
	...
	// Project options.
	projectURL: 'localhost:8080', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	productURL: './', // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.
	browserAutoOpen: true,
	injectChanges: true,

	// Style options.
	styleSRC: './assets/stylesheets/style.scss', // Path to main .scss file.
	...
	// Watch files paths.
	watchStyles: './assets/stylesheets/**/*.scss', // Path to all *.scss files inside css folder and inside them.
